...
/* harmony import */ var _api_twitter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../api/twitter.js */ "./api/twitter.js");
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(_default, [{
    ...
    value: function submitComments(e) {
      ...
      var comments = this.state.image.comments;
      comments.push({
        user: user,
        body: body
      });
      ...
      fetch("http://localhost:4000/photos/".concat(this.state.image.id), {
        method: 'PUT',
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
        },
        body: _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_2___default()(this.state.image)
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(_components_MyLayout_js__WEBPACK_IMPORTED_MODULE_8__["default"], null, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("h1", null, "Visable tweets"), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("form", {
        ...
        type: "submit"
      })), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("ul", null, this.state.tweets.map(function (tweet) {
        ...
        }), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_9___default.a, {
          as: "/p/".concat(tweet.screen_name),
          href: "/post?id=".concat(tweet.screen_name)
        }, react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("a", null, tweet.full_text + " (" + tweet.screen_name + ")")), react__WEBPACK_IMPORTED_MODULE_11___default.a.createElement("p", null));
      })));
    }
  }], [{
    key: "getInitialProps",
        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _api_twitter_js__WEBPACK_IMPORTED_MODULE_10__["default"].search("#visable");
...
//# sourceMappingURL=index.js.beb2d1ab61beab86feaa.hot-update.js.map