        ...
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                req = _ref.req;
                console.log("getInitialProps de Ute"); //console.log(`JSON2.stringify ${JSON2.stringify(req)}`)

                console.log("req.headers['user-agent'] : ".concat(req.headers['user-agent']));
                console.log("JSON.decycle ".concat(_utils_JSON2_js__WEBPACK_IMPORTED_MODULE_11___default.a.pretty(_utils_JSON2_js__WEBPACK_IMPORTED_MODULE_11___default.a.stringify(req))));
...
//# sourceMappingURL=ute.js.4de9a0c0d391f6eb71da.hot-update.js.map