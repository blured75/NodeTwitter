...
function (_React$Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_10__["default"])(Ute, _React$Component);

  function Ute() {
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_6__["default"])(this, Ute);

    return Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_8__["default"])(this, Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_9__["default"])(Ute).apply(this, arguments));
  }

  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_7__["default"])(Ute, [{
    key: "render",
    ...
    value: function cyclicStringify(jsObject) {
      ...
      var serializedData = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_3___default()(jsObject, function (key, value) {
        console.log();
      ...
      serializedData = _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_3___default()(JSON.parse(serializedData), null, 2);
      return serializedData;
    }
  }, {
    key: "decycle",
    value: function decycle(jsObject) {
      /*
          cycle.js
          2018-05-15
          Public Domain.
      ...
      */
      if (typeof JSON.decycle !== "function") {
        JSON.decycle = function decycle(object, replacer) {
          ...
          var objects = new _babel_runtime_corejs2_core_js_weak_map__WEBPACK_IMPORTED_MODULE_2___default.a(); // object to path mappings
          ...
          return function derez(value, path) {
            ...
            if (typeof value === "object" && value !== null && !(value instanceof Boolean) && !(value instanceof Date) && !(value instanceof Number) && !(value instanceof RegExp) && !(value instanceof String)) {
              ...
              if (_babel_runtime_corejs2_core_js_array_is_array__WEBPACK_IMPORTED_MODULE_1___default()(value)) {
                ...
                _babel_runtime_corejs2_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(value).forEach(function (name) {
                  nu[name] = derez(value[name], path + "[" + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_3___default()(name) + "]");
                });
              }
...
//# sourceMappingURL=ute.js.e595480b60e110280af2.hot-update.js.map