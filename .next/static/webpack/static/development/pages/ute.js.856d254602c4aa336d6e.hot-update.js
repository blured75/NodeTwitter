...
/* harmony import */ var _utils_JSON2_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/JSON2.js */ "./utils/JSON2.js");
/* harmony import */ var _utils_JSON2_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_utils_JSON2_js__WEBPACK_IMPORTED_MODULE_12__);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                console.log("JSON2.stringify ".concat(_utils_JSON2_js__WEBPACK_IMPORTED_MODULE_12___default.a.stringify(req)));
                console.log("req.headers['user-agent'] : ".concat(req.headers['user-agent']));
                console.log("JSON.decycle ".concat(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(JSON.decycle(req))));
...
//# sourceMappingURL=ute.js.856d254602c4aa336d6e.hot-update.js.map